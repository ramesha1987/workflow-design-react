            ...
            <React.Fragment>
                <FormGroup>                    
                    ...
                    <FormControl>
                        ...
                        <Input name="name" id="my-input" value="Oracle123" aria-describedby="your field name here"
                    ...
                    <FormControl>
                        ...
                        <Input name="name" id="my-input" value="http://syncron.com/rest/api" aria-describedby="your field name here"
                            onChange={this.handleChange} />
                    </FormControl>
